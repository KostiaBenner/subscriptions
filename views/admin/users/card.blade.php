        <div class="user-card hover:bg-indigo-100">
            ...
            <div class="">
                ...
                <div  class="text-sm text-gray-500 mb-2">
                    ...
                    @lang('subscriptions::admin/users.registered') {{ $user->created_at->format('d.m.Y') }}
                </div>
                @if($user->subscription())
                    <div class="text-sm text-gray-500">
                        @lang('subscriptions::admin/users.tariff') {{ $user->subscription()->name }}
                        @if($user->subscription()->isTrial())
                            @lang('subscriptions::admin/users.till') 
            ...
            <div class="ml-1">
                <a href="javascript:document.user_{{ $user->id }}_delete.submit()" onclick="return confirm('@lang('subscriptions::admin/users.confirmDelete')')">

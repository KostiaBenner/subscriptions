        <div class="user-card hover:bg-indigo-100">
            ...
            <div class="ml-auto">
                ...
                <a href="/tariffs/{{ $tariff->id }}/default" title="@lang('subscriptions::admin/tariffs.default')">
            ...
            <div class="ml-1">
                <a href="/tariffs/{{ $tariff->id }}/edit" title="@lang('subscriptions::admin/tariffs.modify')">
            ...
            <div class="ml-1">
                ...
                <a href="javascript:document.tariff_{{ $tariff->id }}_delete.submit()" onclick="return confirm('@lang('subscriptions::admin/tariffs.confirmDelete')')" title="@lang('subscriptions::admin/tariffs.delete')">
